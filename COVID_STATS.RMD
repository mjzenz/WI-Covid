...
DANE_NEW_VALUES_POSITIVE  + geom_line(aes(y = AVG_7_CHANGE_POS), color = "black") + geom_line(aes(y = CHANGE_POS), color = "red") + labs(y = "", title  = "New Daily Covid-19 Cases in Dane County (red), 7-day Trl. Avg. (black)") 
```
