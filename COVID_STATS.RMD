...
This document contains confirmed Covid-19 cases for the past 3 months as of `r format(MAX_DATE, format = "%A %B %d, %Y")`.
...
STATEWIDE_NEW_DEATHS  + geom_line(aes(y = AVG_7_CHANGE_DEATHS), color = "black") + geom_point(aes(y = CHANGE_DEATHS),color = "red", fill = "red") +  geom_point(aes(y = MAX_DEATHS), fill = "blue" ,color = "blue") + labs(y = "", title  = "Daily WI Deaths (7-day AVG in black, today's value in blue)") 
