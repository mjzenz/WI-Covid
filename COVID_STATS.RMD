...
DANE_NEW_VALUES_POSITIVE <- ggplot(COUNTY_VALUES_DANE, aes(x = Date))
DANE_NEW_VALUES_POSITIVE  + geom_bar(aes(y = CHANGE_POS), stat = "identity", color = "red", fill = "red") + geom_line(aes(y = AVG_7_CHANGE_POS), color = "black") + labs(y = "", title  = "New Daily Covid-19 Cases in Dane County (red), 7-day Trl. Avg. (black)") 
```
