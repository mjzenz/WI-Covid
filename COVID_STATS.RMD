...
DANE_NEW_VALUES_POSITIVE  + geom_line(aes(y = AVG_7_CHANGE_POS), color = "black") + geom_point(aes(y = CHANGE_POS), fill = "red" ,color = "red") + labs(y = "", title  = "New Daily Covid-19 Cases in Dane County (7-day AVG)") 
...
STATEWIDE_NEW_DEATHS  + geom_line(aes(y = AVG_7_CHANGE_DEATHS), color = "black") + geom_point(aes(y = CHANGE_DEATHS),color = "red", fill = "red") + labs(y = "", title  = "New Daily Covid-19 Deaths in WI (7-day AVG)") 
