...
REGION_PERCENT_POSITIVE <- ggplot(REGION_VALUES, aes(Date, AVG_5_PERCENT_POS))
REGION_PERCENT_POSITIVE + geom_line(aes(color = REGION, group = REGION)) + labs(y = "", title = "Prop. Positive Tests (5 day moving average)") + ylim(0,.25)
...
TOP_6_COUNTIES_PERCENT_POSITIVE <- ggplot(COUNTY_VALUES_TOP_6_COUNTIES, aes(Date, AVG_5_PERCENT_POS))
TOP_6_COUNTIES_PERCENT_POSITIVE + geom_line(aes(color = COUNTY, group = COUNTY)) + labs(y = "", title = "Prop. Positive Tests (5 day moving average") + ylim(0,.30)
