...
REGION_AVG_VALUES_POSITIVE_plot <- REGION_AVG_VALUES_POSITIVE + geom_line(aes(color = REGION)) + labs(y = "", title  = "New  Covid-19 Cases (7-day trailing average)") 

ggplotly(REGION_AVG_VALUES_POSITIVE_plot, tooltip = "all")
```
