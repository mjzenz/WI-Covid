...
STATEWIDE_NEW_DEATHS  + geom_line(aes(y = AVG_7_CHANGE_DEATHS), color = "black") + geom_line(aes(y = CHANGE_DEATHS), color = "red") + labs(y = "", title  = "New Daily Covid-19 Deaths in WI (7-day AVG)") 
